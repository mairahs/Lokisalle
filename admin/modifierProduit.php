...
$produit = afficherProduitParSonId($idProduit) ;
                    ...
                    <div class="col-lg-12">
                        ...
                        <form action='' method='POST'>
                        	...
                        	<p class="form-group">
                        		...
                        		<input class='form-control' type="date" name="dateArrivee" id="dateArrivee" placeholder="Date d'arrivée" value="<?php echo $produit['date_arrivee']; ?>">
                        		<?php afficherErreurs('dateArrivee'); ?>
                        	</p>

                        	<p class="form-group">
                                <label for="dateDepart">Date de départ</label>
                                <input class='form-control' type="date" name="dateDepart" id="dateDepart" placeholder="Date de  départ" value="<?php echo $produit['date_depart']; ?>">
                            ...
                            <p class="input-group">
                                ...
                                <input type="text" class="form-control" type="text" name="tarif" id="tarif" placeholder="Prix en euros" value="<?php echo $produit['prix']; ?>">
                                <?php afficherErreurs('tarif'); ?>
                              </p>


                        	<p>
                        		<input class='form-control' type="submit" name="send" value="Modifier un produit" class="button">
                        	</p>
